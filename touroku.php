...
echo "<p>".$new_syain_id."</p>";
    echo "<p>".$new_name."</p>";
    echo "<p>".$new_dap_id."</p>";
    echo "<p>".$new_seibetu."</p>";
        ...
        <body>
            <h1>iYell 社員管理システム</h1>
                <table>
                    <tr>
                        <th>社員番号</th>
                        <td><input type="text" name="bangou" ></td>
                    </tr>
                    <tr>
                        <th>氏名</th>
                    ...
                    <tr>
                            <td><input type="submit" name="送信" value="送信"></td>
                    </tr>
